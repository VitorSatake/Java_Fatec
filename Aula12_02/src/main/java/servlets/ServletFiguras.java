	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try(PrintWriter out = response.getWriter()) {
			...
			if(request.getParameter("num1") != null){
				...
				float v3 = Float.parseFloat(request.getParameter("num3"));
			}
				...
				case "Calcular area Circulo": resultado = new Circulo().calcularArea(num1); break;
				case "Calcular area Retangulo": resultado = new Retangulo().calcularArea(num2, num3); break;
			...
			out.println(String.format("O resultado é: %.2f <br><br>", resultado));
	}
